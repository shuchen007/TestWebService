...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements HelloWorldServer.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/test/services/HelloWorld";
    ...
    public HelloWorldServer.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public HelloWorldServer.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            HelloWorldServer.HelloWorldSoapBindingStub _stub = new HelloWorldServer.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (HelloWorldServer.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                HelloWorldServer.HelloWorldSoapBindingStub _stub = new HelloWorldServer.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
